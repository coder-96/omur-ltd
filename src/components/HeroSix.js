    ...
    const testimonials = [
        {
            ...
            name: "Озген Эргин",
            title: "Руководитель проекта АНТ ЯПЫ",
            quote: "Работы были выполнены в короткий срок и в строгом соответствии с требованиям генподрядчика и заказчика."
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/46.jpg",
            name: "Йюксел Ведат",
            title: "Руководитель проекта АНТТЕК",
            quote: "В процессе производства строительно-монтажных работ командой 'OMUR LTD' особое впечатление было произведено высокой оперативностью решения рабочих вопросов и профессионализмом технических специалистов."
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/86.jpg",
            name: "Гюллю Экрем",
            title: "Коммерческий директор сети ресторанов 'БАРБЕКЮ'",
            quote: "За период сотрудничества, компания 'OMUR LTD' проявила себя как надежный партнер, способный выполнить работы в сжатые сроки и надлежащим качеством."
        },
    ]
            ...
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-xl sm:text-center md:mx-auto">
                    ...
                    <p className="mt-3 text-gray-600">
                        Цитаты с официальных благодарственных писем
                    </p>
                </div>
                <div className="mt-12">
